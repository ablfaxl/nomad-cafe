/* Based on shadcn/ui Sidebar reference implementation. Adjusted imports for this project. [^1] */
"use client"
...
>(function SidebarProvider(
  ...
  const toggleSidebar = React.useCallback(() => {
    return isMobile ? setOpenMobile((v) => !v) : setOpen((v: any) => !v)
  }, [isMobile, setOpen])
...
const SidebarRail = React.forwardRef<HTMLButtonElement, React.ComponentProps<"button">>(function SidebarRail(
  { className, ...props },
  ref
) {
  const { toggleSidebar } = useSidebar()
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<"main">>(function SidebarInset(
  { className, ...props },
  ref
) {
  return (
...
const SidebarMenuBadge = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(function SidebarMenuBadge(
  ...
  return (
    <div
      ...
      className={cn(
        "absolute right-1 flex h-5 min-w-5 select-none pointer-events-none items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground",
...
>(function SidebarMenuSkeleton({ className, showIcon = false, ...props }, ref) {
  ...
  return (
    <div ref={ref} data-sidebar="menu-skeleton" className={cn("h-8 flex items-center gap-2 rounded-md px-2", className)} {...props}>
...
>(function SidebarMenuSubButton({ asChild = false, size = "md", isActive, className, ...props }, ref) {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex min-w-0 h-7 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-none ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
